...
<section>
        ...
        <header>
            <div class="login-wrapper">
                <div class="user-img-wrapper">                    
                    <img src="/NRBOnline/DPGetter?url=<%= user.getPictureURL() %>" alt="photo" style="width:50px;height=:50px;border-radius: 50%;width: 50px; height: 50px;object-fit: cover;" >             
                </div>                
        ...
        <div class="nav-seciton">
            <nav>				
                <ul id="menutab" >
                    ...
                    <li><a class="nav-buttons smooth  Active" onclick="hideShowmenu();find('t');">Loan</a></li>
    ...
    <div class="option-button">
        <button class="button btn1" onclick="window.open('existing-loan.jsp','_self');">Existing Loans</button>
        <button class="button btn3" onclick="window.open('pending-loan.jsp','_self');">Pending Loans</button>        
        <button class="button btn3" onclick="window.open('Guaranting-loan.jsp','_self');">Guaranting Loans</button>
        <button class="button btn2" onclick="window.open('Loan-Request.jsp','_self');">Loan Request</button>
    </div>
