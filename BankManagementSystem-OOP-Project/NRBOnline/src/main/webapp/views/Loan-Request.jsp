...
out.println("<script>var log = document.getElementById('loginBtn'); log.innerHTML='Logout'</script>");
        ...
        <div class="nav-seciton">
            <nav>				
                <ul id="menutab" >
                    ...
                    <li><a class="nav-buttons smooth Active" href="http://localhost:8080/NRBOnline/views/Loan.jsp" onclick="hideShowmenu();find('t');">Loan</a></li>
    ...
    <div class="loan-request">
        <form method="post" action="../ReqLoan">
            <div class="form-row">
              <div class="form-group col-md-6">
                <input type="hidden" class="form-control" id="inputEmail4" placeholder="NIC" name="nic"value="<%=session.getAttribute("userID")%>">
              </div>             
            </div>
            <div class="form-row">
                <div class="form-group col-md-6">
                  <label for="inputEmail4">Guaranter's NIC</label>
                  <input type="text" class="form-control" id="inputEmail4" placeholder="Guaranter's NIC" required name="guaranter">
                </div>             
            </div>
            <br>
            <div class="form-row">
                <div class="form-group col-md-6">
                  <label for="inputEmail4">Base Value</label>
                  <input type="number" class="form-control" step="0.1" id="inputEmail4" placeholder="Base Value" min="10000" max="10000000" pattern="[0-9]{1,9}" required name="basevalue">
                </div>             
            </div>
            <br>
            <div class="form-row">
                <div class="form-group col-md-6">
                  <label for="inputEmail4">No of Insatallments</label>
                  <input type="number" class="form-control" id="inputEmail4" placeholder="Insatallments" min="5" max="60" required name="installments">
                </div>             
            </div>              
            <br>
