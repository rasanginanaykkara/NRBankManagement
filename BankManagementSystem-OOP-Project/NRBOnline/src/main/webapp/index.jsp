...
<%	
	...
	<%}else {		
		session.setAttribute("userID", user.getNic());
    ...
    <div class="header-wrapper">
        <header>
            <div class="login-wrapper">
                ...
                <button type="button" id="loginBtn" class="btn btn-outline-primary" onclick="window.open('views/Login.jsp','_self');">Login</button>  
            </div>
        </header>
        ...
        <div class="nav-seciton">
            <nav>				
                <ul id="menutab" >
                    ...
                    <li><a class="nav-buttons smooth" href="views/Loan.jsp" onclick="hideShowmenu();find('t');">Loan</a></li>
